...
public class ComparingServiceImpl implements ComparingService {
    ...
    @Override
    public void setFightersAdvantages(FighterDetailsResponse fighter1, FighterDetailsResponse fighter2) {
    ...
    public Integer calculateAgeDifference(FighterDetailsResponse fighter1, FighterDetailsResponse fighter2) {
