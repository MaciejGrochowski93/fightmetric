...
class ComparingServiceImplTest {
    ...
    private static FighterDetailsResponse bestFighter;
    private static FighterDetailsResponse goodFighter;
    private static FighterDetailsResponse mediumFighter;
    private static FighterDetailsResponse weakFighter;
    ...
    void prepareEvents() {
        ...
        bestFighter = new FighterDetailsResponse("Ngannou", valueOf(198), valueOf(200), valueOf(5.5), valueOf(60),
                valueOf(2.2), valueOf(70), valueOf(2.5), valueOf(80), valueOf(60), date1);

        goodFighter = new FighterDetailsResponse("Rakic", valueOf(192), valueOf(194), valueOf(5), valueOf(53),
                valueOf(3.2), valueOf(65), valueOf(1.8), valueOf(70), valueOf(55), date2);

        mediumFighter = new FighterDetailsResponse("Whittaker", valueOf(186), valueOf(188), valueOf(4.4), valueOf(46),
                valueOf(4.0), valueOf(60), valueOf(1.2), valueOf(60), valueOf(47), date3);

        weakFighter = new FighterDetailsResponse("Edwards", valueOf(176), valueOf(170), valueOf(3.25), valueOf(30),
    ...
    void setFightersAdvantages_weak_fighter_should_have_no_advantages_over_other_fighters(FighterDetailsResponse fighter) {
        // given + when
    ...
    private static Stream<FighterDetailsResponse> fightersToCompareWithWeak() {
